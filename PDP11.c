...
{
	dd.res = (dword)dd.val + (dword)ss.val;
	if(dd.space == REG)
	{
		reg[dd.ad]= dd.res;
	}
	...
	else
	{
		...
		if(a)
		{
			flags.V = (((dd.res >> 15)&1) ^ ((ss.val >> 15)&1));
		}
	}
}
